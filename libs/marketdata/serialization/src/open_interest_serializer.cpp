...
open_interest_serializer::open_interest_serializer()
{
  data_.resize( 500 +
...
open_interest_serializer::serialize(
  const messages::open_interest& msg )
{
...
std::size_t
open_interest_serializer::buffer_size() const
{
  return data_.size();
}

std::size_t
open_interest_serializer::deserialize( const unsigned char* data,
                                       messages::open_interest& dst )
{
  decimal d;
  std::size_t offset = offset_variable_fields;
