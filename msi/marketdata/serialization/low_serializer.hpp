#ifndef APOENA_MSI_MARKETDATA_SERIALIZATION_LOW_SERIALIZER_HPP
#define APOENA_MSI_MARKETDATA_SERIALIZATION_LOW_SERIALIZER_HPP
...
class MARKETDATA_SERIALIZATION_Export low_serializer
{
public:
  enum offset
  {
  ...
  low_serializer();
  std::pair<const unsigned char*, std::size_t> serialize( const messages::low& msg );
  std::size_t buffer_size() const;
  std::size_t deserialize( const unsigned char* data, messages::low& dst );
...
#endif /* APOENA_MSI_MARKETDATA_SERIALIZATION_LOW_SERIALIZER_HPP */
