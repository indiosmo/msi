#ifndef APOENA_MSI_MARKETDATA_SERIALIZATION_HIGH_SERIALIZER_HPP
#define APOENA_MSI_MARKETDATA_SERIALIZATION_HIGH_SERIALIZER_HPP
...
class MARKETDATA_SERIALIZATION_Export high_serializer
{
public:
  enum offset
  {
  ...
  high_serializer();
  std::pair<const unsigned char*, std::size_t> serialize( const messages::high& msg );
  std::size_t buffer_size() const;
  std::size_t deserialize( const unsigned char* data, messages::high& dst );
...
#endif /* APOENA_MSI_MARKETDATA_SERIALIZATION_HIGH_SERIALIZER_HPP */
