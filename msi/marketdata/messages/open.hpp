#ifndef APOENA_MSI_MARKETDATA_MESSAGES_OPEN_HPP
#define APOENA_MSI_MARKETDATA_MESSAGES_OPEN_HPP
...
class MARKETDATA_MESSAGES_Export open
{
public:
  enum field_index
  {
...
#endif /* APOENA_MSI_MARKETDATA_MESSAGES_OPEN_HPP */
