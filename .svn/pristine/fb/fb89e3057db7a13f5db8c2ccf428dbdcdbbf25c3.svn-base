#ifndef APOENA_MSI_MARKETDATA_MESSAGES_LOW_HPP
#define APOENA_MSI_MARKETDATA_MESSAGES_LOW_HPP
...
class MARKETDATA_MESSAGES_Export low
{
public:
  enum field_index
  {
...
#endif /* APOENA_MSI_MARKETDATA_MESSAGES_LOW_HPP */
